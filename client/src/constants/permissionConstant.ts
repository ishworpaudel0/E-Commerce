const appPermissions = {
    UPDATE_ROLES: {
        name: "UPDATE_ROLES",
        description: "Allows the user to update existing roles and their permissions"
    },
    CREATE_ROLES: {
        name: "CREATE_ROLES",
        description: "Allows the user to create new roles and assign permissions to users"
    },
    VIEW_USERS: {
        name: "VIEW_USERS",
    ...
    UPDATE_USERS: {
        name: "UPDATE_USERS",
        description: "Allows the user to update user details and manage their roles and permissions"
    },
    DELETE_USERS: {
        name: "DELETE_USERS",
    ...
    CATEGORY_MANAGEMENT: {
        ...
        description: "Allows the user to create, update, and delete product categories"
    },
    VIEW_ANALYTICS: {
        name: "VIEW_ANALYTICS",
    ...
    CREATE_PERMISSIONS: {
        ...
        description: "Allows the user to create new permissions and assign them to roles"
    },
    UPDATE_PERMISSIONS: {
    ...
    VIEW_PERMISSIONS: {
        ...
        description: "Allows the user to view the list of permissions and their details"
    },
    VIEW_ROLES: {
        name: "VIEW_ROLES",
    ...
    VIEW_ADMIN_DASHBOARD: {
        ...
        description: "Allows the user to access the admin dashboard and view overall statistics and management options"
    }
